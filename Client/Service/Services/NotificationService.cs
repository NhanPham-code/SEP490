...
namespace Service.Services
{
    public class NotificationService : INotificationService
    {
        ...
        public NotificationService(GatewayHttpClient gateway)
        {
        ...
        {
            var response = await _httpClient.GetAsync($"/notifications/myNotification?$fitler=UserId eq {userId}&$top={top}&$skip={skip}");
