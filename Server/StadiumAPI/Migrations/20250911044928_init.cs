    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Stadiums",
                columns: new[] { "Id", "Address", "AddressUnsigned", "CloseTime", "CreatedAt", "CreatedBy", "CreatedByUser", "Description", "IsApproved", "IsLocked", "Latitude", "Longitude", "Name", "NameUnsigned", "OpenTime", "UpdatedAt" },
                values: new object[,]
                {
                    { 1, "Đường Cách Mạng Tháng Tám, Bình Thủy, Cần Thơ", "duong cach mang thang tam, binh thuy, can tho", new TimeSpan(0, 22, 0, 0, 0), new DateTime(2025, 8, 14, 10, 0, 0, 0, DateTimeKind.Unspecified), 1, 1, "Sân bóng đá cỏ nhân tạo chất lượng cao với hệ thống đèn LED hiện đại.", true, false, 10.0528m, 105.7725m, "Sân Bóng Phi Long", "san bong phi long", new TimeSpan(0, 6, 0, 0, 0), new DateTime(2025, 8, 14, 10, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 2, "Số 45 Cách Mạng Tháng Tám, Cái Khế, Bình Thủy, Cần Thơ", "so 45 cach mang thang tam, cai khe, binh thuy, can tho", new TimeSpan(0, 22, 0, 0, 0), new DateTime(2025, 8, 14, 10, 0, 0, 0, DateTimeKind.Unspecified), 1, 1, "Cụm sân cầu lông rộng rãi, có hệ thống ánh sáng tốt và dịch vụ chuyên nghiệp.", true, false, 10.0401m, 105.7684m, "Sân Cầu Lông Quang Sport", "san cau long quang sport", new TimeSpan(0, 8, 0, 0, 0), new DateTime(2025, 8, 14, 10, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 3, "Đường Nguyễn Đệ, An Hòa, Ninh Kiều, Cần Thơ", "duong nguyen de, an hoa, ninh kieu, can tho", new TimeSpan(0, 22, 0, 0, 0), new DateTime(2025, 8, 14, 10, 0, 0, 0, DateTimeKind.Unspecified), 1, 1, "Sân tennis tiêu chuẩn, phù hợp cho người mới bắt đầu và cả vận động viên chuyên nghiệp.", true, false, 10.0381m, 105.7788m, "Sân Tennis 6 Đời 6", "san tennis 6 doi 6", new TimeSpan(0, 5, 0, 0, 0), new DateTime(2025, 8, 14, 10, 0, 0, 0, DateTimeKind.Unspecified) },
                    ...
                    { 8, "Phú Thứ, Cái Răng, Cần Thơ", "phu thu, cai rang, can tho", new TimeSpan(0, 21, 30, 0, 0), new DateTime(2025, 8, 14, 10, 0, 0, 0, DateTimeKind.Unspecified), 1, 1, "Cụm sân tennis với mặt sân chất lượng cao, phục vụ luyện tập và thi đấu.", true, false, 10.0094m, 105.7877m, "Sân Tennis 586", "san tennis 586", new TimeSpan(0, 5, 30, 0, 0), new DateTime(2025, 8, 14, 10, 0, 0, 0, DateTimeKind.Unspecified) },
                    ...
                    { 11, "96 Chu Văn An, An Khánh, Ninh Kiều, Cần Thơ", "96 chu van an, an khanh, ninh kieu, can tho", new TimeSpan(0, 21, 0, 0, 0), new DateTime(2025, 8, 14, 10, 0, 0, 0, DateTimeKind.Unspecified), 1, 1, "Sân bóng chuyền ngoài trời, là nơi giao lưu của các đội bóng mạnh trong khu vực.", true, false, 10.0240m, 105.7725m, "Sân bóng chuyền 586", "san bong chuyen 586", new TimeSpan(0, 5, 0, 0, 0), new DateTime(2025, 8, 14, 10, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 13, "Hẻm liên tổ 4-5, Hưng Lợi, Ninh Kiều, Cần Thơ", "hem lien to 4-5, hung loi, ninh kieu, can tho", new TimeSpan(0, 22, 0, 0, 0), new DateTime(2025, 8, 14, 10, 0, 0, 0, DateTimeKind.Unspecified), 1, 1, "Sân cầu lông tư nhân, có nhiều sân con, không gian thoáng đãng.", true, false, 10.0152m, 105.7629m, "Sân Cầu Lông Hoàng Long", "san cau long hoang long", new TimeSpan(0, 7, 0, 0, 0), new DateTime(2025, 8, 14, 10, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 14, "37 Đường B3, Hưng Lợi, Ninh Kiều, Cần Thơ", "37 duong b3, hung loi, ninh kieu, can tho", new TimeSpan(0, 22, 30, 0, 0), new DateTime(2025, 8, 14, 10, 0, 0, 0, DateTimeKind.Unspecified), 2, 2, "Sân bóng đá cỏ nhân tạo 7 người, là địa điểm quen thuộc của các đội bóng phong trào.", true, false, 10.0195m, 105.7620m, "Sân bóng đá Anh Tuấn", "san bong da anh tuan", new TimeSpan(0, 6, 0, 0, 0), new DateTime(2025, 8, 14, 10, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 15, "Đường Trần Phú, Cái Khế, Ninh Kiều, Cần Thơ", "duong tran phu, cai khe, ninh kieu, can tho", new TimeSpan(0, 21, 0, 0, 0), new DateTime(2025, 8, 14, 10, 0, 0, 0, DateTimeKind.Unspecified), 3, 3, "Sân tennis thuộc khu vực Công an thành phố, chất lượng tốt, có hệ thống đèn.", true, false, 10.0315m, 105.7765m, "Sân Tennis Công An Cần Thơ", "san tennis cong an can tho", new TimeSpan(0, 5, 30, 0, 0), new DateTime(2025, 8, 14, 10, 0, 0, 0, DateTimeKind.Unspecified) },
                    ...
                    { 19, "Phường 7, Vị Thanh, Hậu Giang", "phuong 7, vi thanh, hau giang", new TimeSpan(0, 22, 0, 0, 0), new DateTime(2025, 8, 14, 10, 0, 0, 0, DateTimeKind.Unspecified), 3, 3, "Cụm sân tennis tiêu chuẩn, có đèn chiếu sáng ban đêm.", true, false, 9.7912m, 105.4820m, "Sân Tennis Phú Hưng", "san tennis phu hung", new TimeSpan(0, 6, 0, 0, 0), new DateTime(2025, 8, 14, 10, 0, 0, 0, DateTimeKind.Unspecified) },
